...
export class SharedService {
 // readonly APIUrl = window.location.protocol+"//"+window.location.host+"/api";
 readonly APIUrl ="https://localhost:5001/api";
  ...
  getClient(val: any): Observable<any> {
    return this.http.get<any>(this.APIUrl + '/Clients/Cliant/' + val);
  }
  ...
  getStatistiquesVehicles(val: any): Observable<any[]> {
    return this.http.get<any>(
      this.APIUrl + '/Vehicules/StatistiquesVehicles/' + val
    );
  }
  VehiclesImmatricule(): Observable<any[]> {
    return this.http.get<any>(this.APIUrl + '/Vehicules/VehiclesImmatricule');
  }
  Vehiculedisp(): Observable<any[]> {
    return this.http.get<any>(this.APIUrl + '/Vehicules/Vehiculedisp');
  }
  getVehicule(val: any): Observable<any> {
    return this.http.get<any>(this.APIUrl + '/Vehicules/Vehicule/' + val);
  }
